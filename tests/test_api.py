...
class TestAllergyIntolerance:
    ...
    def test_happy_path(self, access_token, url):
        ...
        response_entry_resourceType_operationoutcome = bundleObj["entry"][28]["resource"]["resourceType"]
        response_entry_resourceType_allergy = bundleObj["entry"][0]["resource"]["resourceType"]
